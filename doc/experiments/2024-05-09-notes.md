...
- statische Seiten sollten einfach auf >90 zu bringen sein <!-- TODO: warum ist Nuxt (build) nicht über 90???  -->
- außer Astro sind alle lokalen Tests schlechter ausgefallen <!-- TODO: warum? -->
...
- Next und Nuxt fast perfekt <!-- TODO: warum? -->
...
- Astro ist Outlier auf Vercel (ca. 300 ms mehr) <!-- TODO: warum? gibt es ein paar wenige starke Outlier, die den Durchschnitt hochziehen? -->
...
- Alle Frameworks lokal schlechter <!-- TODO: warum? -->
...
- Astro mixed besser als duplicate <!-- TODO: warum? -->
- Angular, Nuxt, Vue, Next und React lokal schlechter
...
- React on Vercel um >2000 ms schlechter <!--TODO: gibt es Outlier-->
...
- Angular ist schlecht, weil jede Komponente einzeln über JS geladen wird, auch wenn kein JS verwendet wird <!-- TODO: stimmt das so? -->
