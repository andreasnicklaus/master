...
Slow load time and reactivity of a web page and its user interface decreases user retention and continuing user actions over time independently from the content. %TODO: source
...
\vspace{1cm}
\begin{lstlisting}[caption=About page in Vue.js (as displayed in figure \ref{fig:uml}), label={lst:Vue:About}, language=HTML]
<!-- AboutView.vue -->
<template>
  <div id="AboutView">
