...
\begin{figure}[ht!]
  ...
  %   \begin{center}
  %     \includegraphics[width=\linewidth, keepaspectratio]{img/lighthouse-results/performanceScore.png}
  %   \end{center}
  %   \caption{Performance score}\label{subfig:LH:performanceScore}
  % \end{subfigure}
  % \begin{subfigure}{0.95\linewidth}
  %   \begin{center}
  %     \includegraphics[width=\linewidth, keepaspectratio]{img/lighthouse-results/CLS.png}
  %   \end{center}
  %   \caption{Cumulative Layout Shift}\label{subfig:LH:cumulativeLayoutShift}
  % \end{subfigure}
  \begin{subfigure}{0.95\linewidth}
    \begin{center}
...
\begin{figure}[ht!]\ContinuedFloat
  ...
  % \begin{subfigure}{0.95\linewidth}
  %   \begin{center}
  %     \includegraphics[width=\linewidth, keepaspectratio]{img/lighthouse-results/FCP.png}
  %   \end{center}
  %   \caption{First Contentful Paint}\label{subfig:LH:firstContentfulPaint}
  % \end{subfigure}
  % \begin{subfigure}{0.95\linewidth}
  %   \begin{center}
  %     \includegraphics[width=\linewidth, keepaspectratio]{img/lighthouse-results/OFCP.png}
  %   \end{center}
  %   \caption{Observed First Contentful Paint}\label{subfig:LH:observedFirstContentfulPaint}
  % \end{subfigure}
  % \begin{subfigure}{0.95\linewidth}
  %   \begin{center}
  %     \includegraphics[width=\linewidth, keepaspectratio]{img/lighthouse-results/OFMP.png}
  %   \end{center}
  %   \caption{Observed First Meaningful Paint}\label{subfig:LH:observedFirstMeaningfulPaint}
  % \end{subfigure}
  % \begin{subfigure}{0.95\linewidth}
  %   \begin{center}
  %     \includegraphics[width=\linewidth, keepaspectratio]{img/lighthouse-results/FMP.png}
  %   \end{center}
  %   \caption{First Meaningful Paint}\label{subfig:LH:firstMeaningfulPaint}
  % \end{subfigure}
  % \begin{subfigure}{0.95\linewidth}
  %   \begin{center}
  %     \includegraphics[width=\linewidth, keepaspectratio]{img/lighthouse-results/OLCP.png}
  %   \end{center}
  %   \caption{Observed Largest Contentful Paint}\label{subfig:LH:observedLargestContentfulPaint}
  % \end{subfigure}
...
\begin{figure}[ht!]\ContinuedFloat
  ...
  % \begin{subfigure}{0.95\linewidth}
  %   \begin{center}
  %     \includegraphics[width=\linewidth, keepaspectratio]{img/lighthouse-results/SI.png}
  %   \end{center}
  %   \caption{Speed Index}\label{subfig:LH:speedIndex}
  % \end{subfigure}
  \begin{subfigure}{0.95\linewidth}
    \begin{center}
  ...
  % \begin{subfigure}{0.95\linewidth}
  %   \begin{center}
  %     \includegraphics[width=\linewidth, keepaspectratio]{img/lighthouse-results/OSI.png}
  %   \end{center}
  %   \caption{Observed Speed Index}\label{subfig:LH:observedSpeedIndex}
  % \end{subfigure}
...
% TODO: redo playwright dyanmic-load tests with fixed interval in performance.js & remove section about 100 ms limit
...
% TODO: write more interpretation about the results
...
The possibility of missing \acrshort{dom} mutations due to the limited recording time being non-zero can be ignored here because other measurements match the interpretation (see section \ref{subsec:componentupdatetimes}). % TODO: move this sentence somewhere else
...
\rowcolor{white} \multirow{-3}{*}{Webkit}            & 172     & 270                       & \cellcolor{red!50}493     & 124                     & 280     & 283     & 200     & 260,286 \\ \hline
...
% Average Playwright results per framework (user actions)
\begin{figure}[ht!]
  \centering
  \begin{subfigure}{0.9\linewidth}
    \begin{center}
